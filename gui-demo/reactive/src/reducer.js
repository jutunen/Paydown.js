...
import { SET_START_DATE, SET_END_DATE, SET_RATE, SET_PRINCIPAL, SET_PAYMENT_METHOD, SET_DAY_COUNT_METHOD, SET_RECURRING_PAYMENT, SET_RECURRING_PAYMENT_DAY, SET_FIRST_RECURRING_PAYMENT_DATE, CLEAR_ALL, ADD_EVENT, DELETE_EVENT, SET_EVENT_DATE, SET_EVENT_RATE, SET_EVENT_REDUCTION, SET_EVENT_INSTALLMENT, SET_EVENT_PAYMENT_METHOD, SET_EVENT_RECURRING_AMOUNT, IMPORT_EXAMPLE_1, IMPORT_EXAMPLE_2, IMPORT_EXAMPLE_3, IMPORT_EXAMPLE_4, TOGGLE_EVENT_INCLUDE, IMPORT_FROM_FILE, SET_TABLE_TITLE, TOGGLE_SUMMARY, TOGGLE_RAWIO, SORT_EVENTS_BY_DATE, SET_INIT_FEE, SET_EVENT_RECURRING_PAYMENT_FEE, SET_EVENT_SINGLE_PAYMENT_FEE, SET_INIT_RECURRING_PAYMENT_FEE, SET_RECURRING_PAYMENT_PERIOD, IMPORT_EXAMPLE_5 } from './actions.js';
import { funcImportBasic, funcImportAdvanced, funcImportNoRecurringPayments, funcImportInterestsOnlyPayments, funcImportNegativeRate } from './AppExamples.js'
...
export function reducer(state = initState, action) {
  ...
  switch(action.type) {
    ...
    case IMPORT_EXAMPLE_5:
      return Object.assign( {}, funcImportNegativeRate(get_new_id) )
